...
//  beehives
//
//  Created by Ahmad Almasri on 6/18/17.
//  Copyright © 2017 Beehives. All rights reserved.
//
...
protocol DateViewDelegate: class {
    ...
    func dateView(_ dateView: DateView, didSelect date: Date)
    func dateViewDidCancelSelection(_ dateView: DateView)
...
class DateView: UIView {
    ...
    struct Config {
        ...
        var headerBackgroundColor: UIColor = UIColor.hexColor(string: "183E7C")
